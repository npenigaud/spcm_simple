...
#if defined(_OPENACC)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zsdiv(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zhelp(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zst(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zsp(1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zsdivp(YDGEOMETRY%YRDIMV%NFLEVG,max(YDGEOMETRY%YRMP%NSPEC2V,YDGEOMETRY%YRMP%NSPEC2VF))
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zspdivp(YDGEOMETRY%YRDIMV%NFLEVG,max(YDGEOMETRY%YRMP%NSPEC2V,YDGEOMETRY%YRMP%NSPEC2VF))
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zsphi(0:YDGEOMETRY%YRDIMV%NFLEVG+1,YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)   ,INTENT(INOUT) ::zout(0:YDGEOMETRY%YRDIMV%NFLEVG,YDGEOMETRY%YRMP%NSPEC2V)
