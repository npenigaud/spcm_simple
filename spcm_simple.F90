...
#if defined(_OPENACC)
IF (LHOOK) CALL DR_HOOK('SPCM_SIMPLE_transfert1',0,ZHOOK_HANDLE2)
!$acc data copy(zspdivg,zsptg,zspspg)
IF (LHOOK) CALL DR_HOOK('SPCM_SIMPLE_transfert1',1,ZHOOK_HANDLE2)
#endif
...
#if defined(_OPENACC)
IF (LHOOK) CALL DR_HOOK('SPCM_SIMPLE_transfert2',0,ZHOOK_HANDLE2)
!$acc end data
IF (LHOOK) CALL DR_HOOK('SPCM_SIMPLE_transfert2',1,ZHOOK_HANDLE2)
#endif
