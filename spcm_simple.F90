...
#if defined(_OPENACC)
REAL(KIND=JPRB)  ::zsdiv(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)  ::zhelp(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)  ::zst(YDGEOMETRY%YRDIMV%NFLEVG,1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)  ::zsp(1:YDGEOMETRY%YRMP%NSPEC2V)
REAL(KIND=JPRB)  ::zsdivp(YDGEOMETRY%YRDIMV%NFLEVG,max(YDGEOMETRY%YRMP%NSPEC2V,YDGEOMETRY%YRMP%NSPEC2VF))
REAL(KIND=JPRB)  ::zspdivp(YDGEOMETRY%YRDIMV%NFLEVG,max(YDGEOMETRY%YRMP%NSPEC2V,YDGEOMETRY%YRMP%NSPEC2VF))
